...
class tb_floquet_tbc_cuda(nn.Module):
    ...
    def compute_chern_marker(self, epsilonT, kappa, steps_per_segment, vdT, extension=0, rotation_angle=torch.pi/4, a=0, b=0, phi1_ex=0, phi2_ex=0, delta=None, initialise=False, fully_disorder=True, plot=False):
        # Define the extended range
        x_start = -extension
        x_end = self.nx + extension
        y_start = -extension
