...
class tb_floquet_tbc_cuda(nn.Module):
    ...
    def H_eff_open(self, steps_per_segment, vdT, theta_x, theta_y, a=0, b=0, phi1_ex=0, phi2_ex=0, rotation_angle=torch.pi/4, epsilonT = torch.pi, delta=None, initialise=False, fully_disorder=True):
        delete, eigenvalues_matrix, wf_matrix = self.quasienergies_states_open(steps_per_segment, vdT, theta_x, theta_y, a=a, b=b, phi1_ex=phi1_ex, phi2_ex=phi2_ex, rotation_angle=rotation_angle, delta=delta, initialise=initialise, fully_disorder=fully_disorder)
