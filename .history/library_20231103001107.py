...
class quasicrystal_pattern:
    ...
    class hamiltonian:
        ...
        def __init__(self, all_tiles):
            self.all_coords = all_tiles
        
        def vertices_coordinates(self, all_coords, precision=12):
            # Flatten the list of lists of tuples
            flattened = [coordinate for sublist in all_coords for coordinate in sublist]
