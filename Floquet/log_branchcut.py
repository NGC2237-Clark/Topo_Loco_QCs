...
for i, epsilonT in enumerate(epsilonT_values):
    ...
    result3 = torch.log(z)  # Standard torch.log
    ...
    plt.plot(theta.numpy(), result3.imag.numpy(), ':', label='torch.log')
    ...
    plt.plot(theta.numpy(), result3.real.numpy(), ':', label='torch.log')
